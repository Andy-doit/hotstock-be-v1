...
export class SendContactDto {
  ...
  @ApiProperty({
    description: 'Nội dung lời nhắn',
    example: 'Tôi muốn hỏi về dịch vụ...',
  })
  ...
  @ApiPropertyOptional({
    description: 'Đồng ý nhận thông tin thị trường và sản phẩm',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({
    description:
      'Người gửi đồng ý điều khoản sử dụng và cho phép xử lý thông tin cá nhân',
    example: true,
  })
  @Equals(true, {
    message:
